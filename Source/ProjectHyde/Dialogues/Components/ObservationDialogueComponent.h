...
#include "ObservationDialogueComponent.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class PROJECTHYDE_API UObservationDialogueComponent : public UBaseDialogueRunnerComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UObservationDialogueComponent();
